...
public class Leccion03HotPublisherAutoConnect {
    private static final Logger log = LoggerFactory.getLogger(Leccion03HotPublisherAutoConnect.class);

    public static void main(String[] args) {


        //autoConnect va a emitir aunque no haya subs
